...
;;;
;;; Title: Frosty's existential dread
;;;
;;; Description:
;;;   Frosty, the snowman
...
(define (draw)
	...
	(define x-steps-per-pixel 3)
	(define y-steps-per-pixel 3)
	(define rays-per-pixel (* x-steps-per-pixel y-steps-per-pixel))

	; Number of render rows must be divisible by height-segments
	; Used to allow for multi processing. Increases divisions of height
	(define height-segments 1)
	; Range is [0, height-segments)
	; Renders the strip with index
	(define height-segment-index 0)
	...
	(define small-snowman-body-material '((0.4 0.4 0.4) (0.8 0.8 0.8) (0.1 0.1 0.1) 1 #f))
	...
	(define big-left-eye-light (list '(20 110 52) '(0.6 0.1 0.1) '(0.8 0.1 0.1)))
	(define big-right-eye-light (list '(40 110 52) '(0.6 0.1 0.1) '(0.8 0.1 0.1)))
